...
export const momo = {
  ...
  redirectUrl: fb('MOMO_REDIRECT_URL', process.env.MOMO_REDIRECT_URL, 'http://localhost:5000/payments/return'),
  ipnUrl:      fb('MOMO_IPN_URL',      process.env.MOMO_IPN_URL,      'https://example.ngrok.io/payments/ipn'),
